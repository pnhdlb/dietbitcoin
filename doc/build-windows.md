...
Below are some notes on how to build DietBitcoin Core for Windows.
...
Building on Ubuntu Xenial 16.04 is known to be broken.
...
way. This will install to `c:\workspace\dietbitcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/dietbitcoin
