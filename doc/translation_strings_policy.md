...
This document provides guidelines for internationalization of the DietBitcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dietbitcoin_en.ts` remains unchanged.
