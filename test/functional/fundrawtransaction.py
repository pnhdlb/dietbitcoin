...
class RawTransactionsTest(DietBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid dietbitcoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
