...
class BIP66Test(DietBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # dietbitcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and dietbitcoind produces more specific reject
            # reasons.
