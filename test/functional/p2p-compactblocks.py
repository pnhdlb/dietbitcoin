...
# TestNode: A peer we use to send messages to dietbitcoind, and store responses.
...
class CompactBlocksTest(DietBitcoinTestFramework):
    ...
    # This test actually causes dietbitcoind to (reasonably!) disconnect us, so do this last.
    ...
    # dietbitcoind's choice of nonce.
    ...
    # Test that dietbitcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for dietbitcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # dietbitcoind will not send blocktxn responses for blocks whose height is
