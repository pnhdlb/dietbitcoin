...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DietBitcoinTestFramework
    pass

class ExampleTest(DietBitcoinTestFramework):
    # Each functional test is a subclass of the DietBitcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        DietBitcoinTestFramework class so other tests can use it."""
