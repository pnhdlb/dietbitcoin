...
from test_framework.test_framework import DietBitcoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (DietBitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that dietbitcoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("dietbitcoind has not been built with zmq enabled.")
