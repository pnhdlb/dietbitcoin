...
unlocked to sign the DietBitcoin-Qt.app bundle.
...
allowing somebody to distribute a DietBitcoin-Qt.app or dietbitcoin-qt-setup.exe with a valid
...
that the dietbitcoin-qt.exe file inside the installer had not been tampered with.
