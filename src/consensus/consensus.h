...
#ifndef DIETBITCOIN_CONSENSUS_CONSENSUS_H
#define DIETBITCOIN_CONSENSUS_CONSENSUS_H
...
// version. The former uses DietBitcoin parameters, but if this fork is a fork
...
#define select_activation_height(height) 28670
...
#endif // DIETBITCOIN_CONSENSUS_CONSENSUS_H
