...
void CChainParams::UpdateForkPorts()
{
    ...
    vSeeds.push_back(CDNSSeedData("162.220.164.58", "quickseed.in"));
...
public:
    CMainParams()
    {
        ...
        consensus.newPowTargetTimespan = 60 * 60;
...
public:
    CTestNetParams()
    {
        ...
        consensus.newPowTargetTimespan = 15 * 60;
        consensus.nPowTargetSpacing = 10 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.DigishieldCalculation = true;
        ...
        vSeeds.emplace_back("testnet-seed.dietbitcoin.jonasschnelli.ch", true);
...
public:
    CRegTestParams()
    {
        ...
        consensus.BIP34Height = 500; // This is deactivated on dietbitcoin, but we activate it on the fork block here, as we otherwise won't get the fork hash coinbase
