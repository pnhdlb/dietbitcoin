...
#ifndef DIETBITCOIN_WALLET_WALLET_H
#define DIETBITCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this dietbitcoin node, and set to 0 for transactions that were created
...
#endif // DIETBITCOIN_WALLET_WALLET_H
