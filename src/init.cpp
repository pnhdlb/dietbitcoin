 ...
 * between dietbitcoind, and dietbitcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("dietbitcoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), DIETBITCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dietbitcoin/dietbitcoin>";
    const std::string URL_WEBSITE = "<https://dietbitcoincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("dietbitcoin-loadblk");
...
/** Sanity checks
 *  Ensure that DietBitcoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("DietBitcoin version %s\n", FormatFullVersion());
}
...
bool AppInitParameterInteraction()
{
    ...
    if (gArgs.GetBoolArg("-disablefork", false)) {
        printf("NOTE: disabling fork; this node will run on the dietbitcoin network\n");
        FORK_ALLOWED = false;
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single DietBitcoin process is using the data directory.
...
// ********************************************************* Step 4a: application initialization
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", DIETBITCOIN_CONF_FILENAME)).string());
