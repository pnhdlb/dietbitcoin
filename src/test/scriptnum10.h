...
#ifndef DIETBITCOIN_TEST_SCRIPTNUM10_H
#define DIETBITCOIN_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from DietBitcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // DIETBITCOIN_TEST_BIGNUM_H
