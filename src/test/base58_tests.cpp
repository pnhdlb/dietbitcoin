...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if (isPrivkey) {
            ...
            // Note: CDietBitcoinSecret::SetString tests isValid, whereas CDietBitcoinAddress does not!
