...
#ifndef DIETBITCOIN_QT_DIETBITCOINUNITS_H
#define DIETBITCOIN_QT_DIETBITCOINUNITS_H
...
/** DietBitcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DietBitcoinUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DietBitcoinUnits(QObject* parent);

    /** DietBitcoin units.
      @note Source: https://en.dietbitcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        DDX,
        mDDX,
...
typedef DietBitcoinUnits::Unit DietBitcoinUnit;

#endif // DIETBITCOIN_QT_DIETBITCOINUNITS_H
