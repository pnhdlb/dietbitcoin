...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR DIETBITCOINS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("%1 will close now to finish the encryption process. "
                               ...
                               "your dietbitcoins from being stolen by malware infecting your computer.")
                                .arg(tr(PACKAGE_NAME)) +
                            "<br><br><b>" +
